...
var _user$project$Main$viewTeams = F2(
	function (currentTeam, teams) {
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								ctor: '_Tuple2',
								_0: 'myturn',
								_1: _elm_lang$core$Native_Utils.eq(currentTeam, _p1._0)
							}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
		...
		var teamsHtml = A2(_elm_lang$core$List$map, teamToHtml, teams);
		return A2(
			_elm_lang$html$Html$ul,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('teamContainer')
				]),
			teamsHtml);
	});
var _user$project$Main$viewColumns = function (columns) {
	var colToHtml = function (_p3) {
		...
		var answerToHtml = function (_p5) {
			...
			return _p7.show ? A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('answer done')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
	...
	var cols = A2(_elm_lang$core$List$map, colToHtml, columns);
	return A2(
		_elm_lang$html$Html$ul,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('colContainer')
			]),
		cols);
};
		...
		function (ans, cId, aId) {
			var showQuestion = function () {
					...
					if ((_p11.ctor === 'Done') && (_p11._0.ctor === 'RanOut')) {
						return _elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('To slow')
									]))
							]);
					} else {
						return _elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('Wrong')
									]))
							]);
					}
				}();
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$id('question')
						]),
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(ans.question),
								A2(
								_elm_lang$html$Html$br,
								_elm_lang$core$Native_List.fromArray(
									[]),
			...
			var showAnswer = A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('answer')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(ans.answer),
						A2(
						_elm_lang$html$Html$br,
						_elm_lang$core$Native_List.fromArray(
							[]),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Show Question')
							])),
						_user$project$Main$viewTimer(model)
					]));
			return model.showQuestion ? showQuestion : showAnswer;
		});
	var grid = A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Jeopardy')
					])),
